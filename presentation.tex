...
\node [xshift=\paperwidth/2,yshift=-\headheight] (mybar) at (current page.north west)[rectangle,fill,inner sep=0pt,minimum width=\paperwidth,minimum height=2\headheight,top color=myblue!64,bottom color=myblue]{}; % Colored bar
...
\newcommand*{\myauthor}{test2 Smith} % Presenters name(s)
...
\begin{multicols}{5} % Divide text into multiple columns
...
The most common definition of \myblue{Murphy's Law} is as follows.
